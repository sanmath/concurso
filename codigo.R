...
#Carga de librerías importantes
...
#A continuaci�n realizamos un match entre los nodos y enlaces por codigo, de este modo sabemos 
View(Enlaces)
...
setwd("C:/Users/Usuario/Documents/GitHub/Lecciones-de-R/MAPAS/concurso/Reto MINTEL Campus Party/concurso_codigos/03 Informaci�n Hospitales")
